...
%HEVEA\begin{center}\textit{This document is also available as a \href{https://github.com/jmbtutor/one-mans-trash/releases/download/v\theversion{}/one-mans-trash-\theversion{}.pdf}{PDF}. The PDF is authoritative for any discrepancies between it and this document.}\end{center}
