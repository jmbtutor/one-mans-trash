...
You may swap multiple cards from your hand if the cards have the same rank and if there are at least the same number of cards on the top of the Trash Heap with the same rank. For example, if the top of the Trash Heap has two 4s and you have two 8s in your hand, you may swap those two 8s for those two 4s.
